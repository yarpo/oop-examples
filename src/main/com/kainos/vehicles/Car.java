...
public class Car implements Vehicle {
    ...
    public void stop() {
        ...
        while (currentSpeed > 0) {
            ...
            log("Current speed of my car = " + currentSpeed);
        }

        drivingForce.stop();
        currentSpeed = 0;
        log("I have parked my car.");
    }
    ...
    public void start() {
        ...
        log("I have started. Current speed of my car = " + currentSpeed);
    }

    @Override
    public void turnLeft() {
        log("I'm turning left easily - power steering rulez");
    }

    @Override
    public void turnRight() {
        log("I'm turning right easily - power steering rulez");
    }
    ...
    public void speedUp() {
        if (isMoving()) {
            ...
            if (currentSpeed >= drivingForce.getMaxSpeed()) {
                ...
                log("RRRyyyyyy!!! My current speed is " + currentSpeed);
            }
        } else {
            log("I'm not moving!");
        }
